...
export default function Page() {
  return (
    ...
    <div className=" bg-white relative h-full">
      ...
      >
        <div className="col-span-7  gap-x-3 p-4 border-2 mx-8 my-5">
        ...
        <div className="col-span-3  py-2 mx-8 my-5">
      ...
      <div className="flex flex-col gap-y-4 p-2 mx-8 max-h-[calc(100vh-400px)] overflow-auto custom-scroll">
      ...
      <div
        className="flex items-center justify-center gap-x-2 felx-1 mt-10"
      >
        <button
          className="px-3 py-1  bg-[#02FFD1] border-2  "
        >
          1
        </button>
        <button
