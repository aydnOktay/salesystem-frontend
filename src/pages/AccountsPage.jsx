  ...
  return (
    <>
      <div className="grid grid-cols-10 bg-white relative">
        <div className="bg-[#02FFD1] p-2 absolute bottom-5 left-5 border-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="size-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
        </svg>
        </div>
        {/* person list */}
        <div className="sm:border-r-2 h-[110vh] col-span-5 sm:col-span-3">
          <div className="p-6">
            {" "}
            ...
            <div>
              {person?.map((person, index) => (
                <div
                  key={index}
                  className="relative flex items-center space-x-3 rounded-lg   py-5 shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400"
                >
        ...
        <div className="sm:flex hidden flex-col lg:border-r-2 p-4 px-10 sm:col-span-7 col-span-5  lg:col-span-5 gap-5 ">
          ...
          <div className="conversation  flex">
            ...
            >
              ...
              <p className="p-4 text-[13px]">
                ...
                Accusamus, animi quis numquam soluta nobis explicabo! Laboriosam
                dolorum culpa aliquid ducimu
              </p>
            </div>
          </div>
          ...
          <div className="border border-gray-300 h-[70vh]">
            {/* chat */}
            <div className="relative flex items-center space-x-3  border-b mx-7 py-3 mt-7 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
              <div className="flex-shrink-0">
                <img
                  alt=""
                  src={"/mattia.jpg"}
              ...
              <div className="min-w-0 flex-1">
                <span aria-hidden="true" className="absolute inset-0" />
                <div className="flex justify-between">
                  <p className="text-lg font-medium text-gray-900">Salesflare</p>
            ...
            <div className="relative flex items-center space-x-3  border-b mx-7 py-3 mt-7 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
              ...
              <div className="min-w-0 flex-1">
                <span aria-hidden="true" className="absolute inset-0" />
                <div className="flex justify-between">
                  <p className="text-lg font-medium text-gray-900">Funnel Consulting</p>
                  <p className="text-[15px] text-gray-400 px-2">12.05.2023</p>
                </div>
                <div>
                  {" "}
          ...
          <div className="border border-gray-300 w-full px-7 py-2 flex justify-between ">
            <div className="flex">
              <div className="bg-[#02FFD0] border-2 border-gray-300 flex justify-center items-center mr-2">   <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                strokeWidth="1.5"
        ...
        <div className="col-span-2 bg-gray-50 pr-8 lg:flex lg:flex-col hidden">
          <div className="flex flex-col col-span-1 px-5 border-b-2 py-4">
            ...
            <div className="xl:flex xl:justify-between grid justify-center gap-2 w-full items-center ">
              <div className="flex gap-2"><div className="flex flex-col">  <h1 className="text-lg font-bold">Account</h1>
                <h3 className="text-xs">SalesPark</h3> </div>
                <img
                  alt=""
                  src={"/person1.jpeg"}
          ...
          <div className="flex flex-col col-span-1 px-5 border-b-2 py-4">
            ...
            <div className="flex gap-2 mt-2"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#02FFD1" className="size-6">
            ...
            <div className="flex gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#02FFD1" className="size-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
              </svg>
              <p>60 utenti attivi</p>
            </div>
            <div className="flex justify-end gap-1 mt-5"> <button className="bg-[#02FFD1] border-2 px-5 text-xs py-1">Edit</button>
              <button className="bg-white border-2 px-3 text-xs py-1">Show more</button></div>
          ...
          <div className="flex flex-col col-span-1  border-b-2 pt-4">
            ...
            <div className="flex justify-end mt-4"><button className="bg-[#02FFD1] border-2 px-5 text-xs py-1">Creat</button>
            </div>

            <h1 className="text-xl font-semibold px-5 mt-5">Nessun contatto</h1>
            <p className="px-5 text-xs mb-9">Nessun contatto suggerito trovato</p>


            <div className="px-5 flex gap-2 items-center justify-between">
              <div className="flex gap-2 items-center"> <h1 className="font-bold text-lg">Contatti</h1>
                {/* search-icon */}
              ...
              <div className="bg-[#02FFD1] p-1"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-3">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
              </svg>
              </div>
            </div>
          ...
          <div className="overflow-auto h-[30vh]">
            <div className="relative flex items-center space-x-3  border-b mx-7 py-3  focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
              <div className="flex-shrink-0">
                <img
                  alt=""
                  src={"/person1.jpeg"}
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex justify-between items-center gap-2">
                  <p className="text-xs font-medium text-gray-900 text-nowrap">Matteo  Mirabella</p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
